...
export const ACTIVITY = [
  { id: 't1', type: 'allocation', text: 'Laptop AF-0114 allocated to Priya Shah (IT Ops)', time: '2 min ago', icon: 'user-plus' },
  { id: 't2', type: 'booking', text: 'Room B2 booking confirmed (2:00 – 3:00 PM)', time: '18 min ago', icon: 'calendar' },
  { id: 't3', type: 'maintenance', text: 'Projector AF-0062 maintenance resolved', time: '1 hr ago', icon: 'wrench' },
  { id: 't4', type: 'transfer', text: 'Transfer request raised: AF-0115 (Ananya → Sneha)', time: '3 hr ago', icon: 'arrow-left-right' },
  { id: 't5', type: 'alert', text: 'Camera AF-0089 return overdue by 5 days', time: '5 hr ago', icon: 'alert-triangle' },
  { id: 't6', type: 'audit', text: 'Q2 Asset audit checkpoint completed (Floor 2)', time: 'Yesterday', icon: 'clipboard-check' },
  { id: 't7', type: 'booking', text: 'Room A1 booked by Ananya Patel (9:00 – 10:00 AM)', time: 'Yesterday', icon: 'calendar' },
  { id: 't8', type: 'allocation', text: 'iPad AF-0210 handed over to Arjun Mehta', time: '2 days ago', icon: 'user-plus' },
]
